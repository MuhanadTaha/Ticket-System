        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.AgentUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.AgentUser));
                    }

                    if (!await _roleManager.RoleExistsAsync(SD.BackOfficeUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.BackOfficeUser));
                    }
